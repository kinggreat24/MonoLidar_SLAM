...
namespace ORB_SLAM2
{
    ...
    public:
        ...
        cv::Mat GrabImageMonocularLidar(const cv::Mat &im, const std::string &lidar_files, const double &timestamp);
    ...
    public:
        ...
        HybridSparseAlign* mpHybridSparseAlign;
        tracker_t tracker_; //直接法参数
    ...
    protected:
        ...
        void MonocularLidarInitialization();
...
#ifdef USE_LIDAR
        // Lidar feature
        LidarFeatureExtractor *mpLidarFeatureExtractor;
#endif
